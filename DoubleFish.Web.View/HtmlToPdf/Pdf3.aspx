<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pdf3.aspx.cs" Inherits="DoubleFish.Web.View.HtmlToPdf._Pdf3" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>PDFVision</title>
	<script type="text/javascript">
		function htmlToPdf() {

			var url = document.getElementById("txtUrl").value;
			var pdf = document.getElementById("txtPdf").value;
			window.open("Pdf3.aspx?pdf=" + pdf + "&url=" + url + "");
		}
	</script>
</head>
<body>
