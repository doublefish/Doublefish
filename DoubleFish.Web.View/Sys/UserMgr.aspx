<%@ Page Title="用户管理" Language="C#" MasterPageFile="~/MpIframe.Master" AutoEventWireup="true"
	CodeBehind="UserMgr.aspx.cs" Inherits="DoubleFish.Web.View.Sys._UserMgr" %>
...
<asp:Content ID="contentHead" ContentPlaceHolderID="cphHead" runat="server">
	...
	<script src="../common/js/sys/user.js" type="text/javascript"></script>
...
<asp:Content ID="contentBody" ContentPlaceHolderID="cphBody" runat="server">
	...
	<div class="list">
		<table id="table" cellpadding="0" cellspacing="0" border="1" style="width: 100%;">
			<thead>
				<tr>
					<th>
						Id
